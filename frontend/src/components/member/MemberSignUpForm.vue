  ...
  <div>
    <v-container class="container" justify="center">
      <v-form ref="form" lazy-validation>
        ...
        <div class="phone-number">
          <table v-if="numberCheck == false">
            <tr>
              ...
              <td>
                ...
                <v-btn @click="checkPhoneNumber()"> 번호인증 </v-btn>
              </td>
            </tr>
          </table>
          <table v-if="numberCheck == true">
            <tr>
              ...
              <td>
                <input class="cell-phone" type="text" v-model="mobile" />
                <v-btn @click="checkPhoneNumber()"> 재전송 </v-btn>
              </td>
            </tr>
          </table>
        </div>
          ...
          <table v-if="numberCheck == true && this.certification == false">
            <tr>
              ...
              <td>
                ...
                <v-btn @click="checkNumber()"> 확인 </v-btn>
              </td>
            </tr>
          </table>
            ...
            <tr>
              ...
              <td>
                <input
                  ...
                  readonly
                />
                <v-btn @click="checkNumber()" disabled> 확인 </v-btn>
              </td>
            </tr>
          </table>
        </div>
        ...
        <div class="button">
          <v-btn text @click="signUp()"> 가입 </v-btn>
          <v-btn class="grey--text" text @click="cacelSignUp()"> 취소 </v-btn>
        </div>
      </v-form>
    </v-container>
    <footer>
