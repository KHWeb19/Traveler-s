...
public class RoomResponseDTO {
    ...
    public static List<RoomResponseDTO> roomBuilder(List<Room> rooms) {
    ...
    public static RoomResponseDTO roomBuilder(Room room) {
        RoomResponseDTO roomRequestDTOList = RoomResponseDTO.builder()
